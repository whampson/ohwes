...
// struct __attribute__ ((packed))      // TODO: figure out packing on macOS
// {
//     char Sequence   : 5;
//     char _Reserved0 : 1;
//     char FirstEntry : 1;
...
/**
 * Check if a directory entry is the current directory (.).
*/
...
/**
 * Check if a directory entry is the parent directory (..).
*/
