...
| `ESC 7`           | DECSC | Save Console      | Saves the console state (cursor properties, graphics attribute, blink status). |
| `ESC 8`           | DECRC | Restore Console   | Restores the console state most-recently saved by `ESC 7`. |
...
| `CSI`*n*`m`       | SGR   | Set Graphics Attribute | Sets text attributes for subsequent characters. ([see below](#'Set-Graphics-Attribute'-Parameters)) |
...
| `2`       | Dim Foreground    | Use dark gray foreground to simulate dim text.|
| `3`       | Italic            | Simulate italic text with color.              |
| `4`       | Underline         | Simulate underline text with color.           |
...
| `23`      | No Italic         | Turn off italic.                              |
| `24`      | No Underline      | Turn off underline.                           |
